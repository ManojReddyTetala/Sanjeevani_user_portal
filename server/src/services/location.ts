export interface GeocodedLocation {
  ...
  country: string;
  place_id?: string;
  source: 'GOOGLE_GEOCODING' | 'NOMINATIM' | 'PRESET_DATABASE';
}
...
const PRESET_GEO_CACHE: Record<string, GeocodedLocation> = {
...
export async function fetchLocationAutocomplete(query: string): Promise<LocationAutocompleteSuggestion[]> {
...
export async function resolveLocationQuery(query: string): Promise<GeocodedLocation> {
